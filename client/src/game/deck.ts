...
const standardCards: Card[] = [
  ...
  { id: "icewall", name: "氷壁弾", code: "C", tier: "standard", family: "属性", target: "near", rangeLabel: "最寄り敵＋近くの空きマス", power: 40, description: "最も近い敵へ40ダメージ。近くの空き敵陣マスに耐久70の氷壁を残す" },
  ...
  { id: "web", name: "樹網", code: "E", tier: "standard", family: "属性", target: "enemy-field", rangeLabel: "最寄り敵中心の2×2", power: 25, status: "root", durationMs: 1500, description: "最も近い敵を中心とする2×2範囲へ25ダメージと1.5秒拘束" },
  { id: "slash", name: "近接斬", code: "A", tier: "standard", family: "近接", target: "near", power: 80, description: "正面の1マスへ80ダメージ" },
  { id: "sweep", name: "横薙ぎ", code: "A", tier: "standard", family: "近接", target: "column", power: 70, description: "正面の縦3マスへ70ダメージ" },
  ...
  { id: "gustwall", name: "乱流壁", code: "B", tier: "standard", family: "地形", target: "enemy-field", rangeLabel: "敵陣全行", power: 0, description: "全行へ風を送り、敵と押せる設置物を1列後退させ、敵の障壁を半分にする" },
...
export function validateSelection(
  ...
  // Every card displayed in the five-card offer is independently selectable.
  ...
  return { valid: true, rule: null, reason: "表示されたカードを選択しました" };
}
